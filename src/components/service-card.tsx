...
export function ServiceCard({
  ...
  return (
    <Link
      ...
      className="group flex h-full flex-col rounded-[1.6rem] border border-line bg-canvas/40 p-6 transition-transform duration-300 hover:-translate-y-1 hover:border-ink/20 sm:p-7"
    >
